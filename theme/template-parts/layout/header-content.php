...
<header id="masthead">
	...
	<nav id="site-navigation" aria-label="<?php esc_attr_e( 'Main Navigation', 'vgday-tailwindv4' ); ?>">
		<button aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'vgday-tailwindv4' ); ?></button>
